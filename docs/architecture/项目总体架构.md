...
| 文件 | 职责 |
|------|------|
| `src/ui/views/processing/SummaryPanel.tsx` | 总结控制面板 |
| `src/ui/views/processing/EntityConfigPanel.tsx` | 实体提取配置 |
| `src/ui/views/memory-stream/index.tsx` | 记忆流可视化 |
| `src/ui/views/api-presets/` | API 和提示词配置 |
