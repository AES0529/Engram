                        ...
                        return (
                            ...
                            >
                                <Icon
                                    ...
                                    className="shrink-0 transition-transform duration-(--duration-fast) group-hover:scale-110"
                                />
                    ...
                    {NAV_ITEMS.map((item) => {
                        ...
                        return (
                            ...
                            >
                                <Icon
                                    size={22}
                                    className={`transition-transform duration-(--duration-fast) group-hover:scale-110 ${isActive ? 'text-primary' : 'text-muted-foreground/70'}`}
                                />
